...
export class TrainingCardComponent {
  ...
  constructor(private snackService: SnackService, private trainingService: TrainingService){}
  ...
  toggleFavorite(e: MouseEvent) {
    ...
    this.snackService.show(this.training.favorited ? 'Removido dos favoritos' : 'Adicionado aos favoritos', this.training.favorited ? 'error' : 'success');
